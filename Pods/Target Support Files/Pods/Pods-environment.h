...
// Hakuba
#define COCOAPODS_POD_AVAILABLE_Hakuba
#define COCOAPODS_VERSION_MAJOR_Hakuba 1
#define COCOAPODS_VERSION_MINOR_Hakuba 0
#define COCOAPODS_VERSION_PATCH_Hakuba 2
